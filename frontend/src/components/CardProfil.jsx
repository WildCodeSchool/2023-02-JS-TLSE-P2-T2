    ...
    dataTabUsers && (
      <div>
        <div className="xl:w-[50dvw] xl:flex xl:flex-wrap xl:justify-center xl:gap-5">
          {dataTabUsers.map((el) => (
            <ul
              className="transition ease-in-out delay-150 shadow-md shadow-gray-300 hover:-translate-y-1 hover:scale-105 hover:shadow-lg hover:shadow-gray-300 duration-300 opacity-80 hover:opacity-100 before:hidden xl:block xl:rounded-xl xl:box-border xl:bg-white xl:text-blue-700 xl:w-[40%]"
              key={el.id}
            >
